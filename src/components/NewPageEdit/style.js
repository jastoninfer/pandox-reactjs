...
const getEditorTabStyle = (displaytype) => {
    if (displaytype === 'edit') {
        console.log('+++++');
        return `
            &:hover {
...
export const EditHeaderContainer = styled.div(({displaytype, scroll}) => (`
    width: 100%;
    height: 4.5em;
    display: flex;
    ...
    div.edit-header {
        ...
        a {
            ...
            // }
            // &.edit {
            //     background-color: ${displaytype==='edit' ? theme.colors.border_grey: 'transparent'};
            //     color: ${displaytype==='edit' ? theme.colors.clay_blue: theme.colors.black};
            //     pointer-events: ${displaytype==='edit' ? 'none' : 'auto'};
            //     // outline: ${displaytype==='edit' ? `.5px solid ${theme.colors.clay_blue}` : 'none'};
            // }
            // &.preview {
            //     background-color: ${displaytype==='preview' ? theme.colors.border_grey: 'transparent'};
            //     color: ${displaytype==='preview' ? theme.colors.clay_blue: theme.colors.black};
            //     pointer-events: ${displaytype==='preview' ? 'none' : 'auto'};
            //     // outline: ${displaytype==='preview' ? `.5px solid ${theme.colors.clay_blue}` : 'none'};
            // }
            // &.preview:hover{
            //     outline: ${displaytype==='edit' ? `1px solid ${theme.colors.dark_grey}` : 'none'};
            // }
            // &.edit:hover{
            //     outline: ${displaytype==='preview' ? `1px solid ${theme.colors.dark_grey}` : 'none'};
            // }
        }
