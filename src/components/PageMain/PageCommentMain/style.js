...
export const AvatarContainer = styled('div')(({displaytype})=>(`
...
export const ReplyBox = styled('div')(({displaytype}) => (`
    display: flex;
    margin-top: .3em;
    gap: .3em;
    flex-direction: column;
...
export const BlogCommentItemContent = styled('div')(({displaytype})=>(`
...
export const PageCommentPaginationBarContainer = styled('div')(({displaytype})=>(`
    margin-top: 2em;
    display: flex;
    margin-left: ${(displaytype==='subcomment' ? '24px' : '0px')};
